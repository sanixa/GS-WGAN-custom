...
CUDA_VISIBLE_DEVICES=5 python main.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_inf_z100 -noise 0
CUDA_VISIBLE_DEVICES=5 python main.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_1000_z100 -noise 0.41
CUDA_VISIBLE_DEVICES=5 python main.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_100_z100 -noise 0.531
CUDA_VISIBLE_DEVICES=5 python main.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_10_z100 -noise 1.45
CUDA_VISIBLE_DEVICES=5 python main.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_1_z100 -noise 14.5
...
CUDA_VISIBLE_DEVICES=5 python main_ts.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_10_ts_z100 -noise 1.45
CUDA_VISIBLE_DEVICES=5 python main_mp.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_10_mp_z100 -noise 1.45
CUDA_VISIBLE_DEVICES=5 python main_lap.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_10_lap_z100 -noise 1.45
CUDA_VISIBLE_DEVICES=5 python main_ge.py --dataset 'cifar_10' -latent bernoulli -ndis 1000 -ngpu 1 -iter 20000 -zdim 100 --exp_name main_eps_10_ge_z100 -noise 1.45
